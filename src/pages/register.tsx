...
const Registesr = () => {
    ...
    const {
        ...
        onSubmit: async ({
            firstName, lastName, email, username, password, agreement,
        }) => {
            try {
                        ...
                        <div className="w-90 ml-8">
                            <form onSubmit={handleSubmit}>
                                ...
                                <InputComponent
                                    ...
                                    error={errors.email ? errors.email : null
                                        || touched.email && fErrors.email
                                        ? fErrors.email : undefined}
                                    id="email"
                                ...
                                <InputComponent
                                    ...
                                    error={touched.confirmPassword && fErrors.confirmPassword
                            ...
                            <small>
                                ...
                                <Link href="/login">
                                    ...
                                    <a className="ml-1 text-blue-600 uppercase">Login</a>
                                </Link>
                            </small>
                        </div>
                    </div>
